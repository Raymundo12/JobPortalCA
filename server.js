...
//dependencies,modules references
const http = require('http');
//const axios = require('axios');
logger = require('morgan');
cors = require('cors');//"provides Express middleware to enable CORS with various options"
bodyParser = require('body-parser');//"helps to parse the request and create the req.body object"
mongoose = require('mongoose');
multer = require('multer');
const dotenv = require('dotenv');
express = require('express');//"is for building the Rest apis"
...
var port = process.env.PORT || 8000;//set port, listen for incoming requests + for heroku deployment
dotenv.config();
...
app.listen(port, function(err){
    console.log('Listening on port: ' + port);//set port, listen for requests
});
